    ...
    return (
        <div className='mb-40 my-10'>
            <div className='text-center my-10'>
                <h1 className='text-3xl font-bold text-red-300 text-center my-6 underline'>Our Team</h1>
                <p className='text-gray-500'>These are all our team members. Our team members will handle everything for your event.</p>
            </div>
